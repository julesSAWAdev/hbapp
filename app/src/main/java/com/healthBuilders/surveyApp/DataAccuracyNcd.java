...
public class DataAccuracyNcd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_accuracy_ncd);
        ...
        savenext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean var = myDb.registerDatamanagementNcd(xyear,xdistrict,xhc,xpatientfile,xregister,xhmis_hardcopy,xhmis_softcopy,xacurrate);
                if (var) {


                    Intent intent = new Intent(getBaseContext(), DataAccuracyBcg.class);
                    ...
                    Toast.makeText(DataAccuracyNcd.this, "An error occured", Toast.LENGTH_SHORT).show();
