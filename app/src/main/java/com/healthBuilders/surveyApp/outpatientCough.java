...
public class outpatientCough extends AppCompatActivity {
    AutoCompleteTextView assesment,classification,correcttreatment,patienteducated;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outpatient_cough);
