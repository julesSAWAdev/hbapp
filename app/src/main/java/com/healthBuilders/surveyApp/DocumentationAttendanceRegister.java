...
public class DocumentationAttendanceRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_documentation_attendance_register);
        ...
        savenext=findViewById(R.id.attendnext);
        ...
        savenext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean var = myDb.registerDocumentationAttendance(xyear,xdistrict,xhc,xavailable,xtracked);
                if (var) {


                Intent intent = new Intent(getBaseContext(), DocumentationPayableRegisters.class);
