...
public class outpatientMalaria extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outpatient_malaria);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (var) {
                    ...
                    Toast.makeText(outpatientMalaria.this, "An error occured", Toast.LENGTH_LONG).show();
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getBaseContext(), outpatientFever .class);
